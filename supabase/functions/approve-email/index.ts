...
const CONFIRM_PAGE = "https://laurenbur2.github.io/awkn-ranch/admin/email-confirm.html";
const RESULT_PAGE = "https://laurenbur2.github.io/awkn-ranch/admin/email-approved.html";
...
async function processPayrollApproval(html: string, supabaseUrl: string, supabaseKey: string): Promise<void> {
  ...
  if (has_stripe) {
        ...
        body: JSON.stringify({
          ...
          data: {
            _raw_html: `<h2 style="color:#c62828;">Payout Failed</h2>
              ...
              <p>You can retry the payout manually from the <a href="https://laurenbur2.github.io/awkn-ranch/spaces/admin/worktracking.html">Work Tracking</a> page.</p>`,
          },
        }),
      });
    } else {
    ...
    try {
      ...
      let setupUrl = "https://laurenbur2.github.io/awkn-ranch/associates/worktracking.html";
